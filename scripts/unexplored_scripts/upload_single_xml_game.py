...
# --- FILE TO PROCESS ---
file_path = "BasketballXMLs/2023-2024/11-11-2023.XML"
...
cur.close()
conn.close()
print("🎉✅ Single game loaded into PostgreSQL.")

## run this in the terminal to execute: python3 scripts/upload_single_xml_game.py
